import { DAY_KEYS, type DayKey, type PoolRecord, type PoolStatusInfo, type ProgramType, type TimeRange } from "../types.js";
...
export function computePoolStatus(pool: PoolRecord, now: PacificNow = getPacificNow()): PoolStatusInfo {
...
function findNextOpening(pool: PoolRecord, now: PacificNow): string | undefined {
